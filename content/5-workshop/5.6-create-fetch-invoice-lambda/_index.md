...
![Open Lambda Console](/images/5-Workshop/5.6-create-fetch-invoice-lambda/001-openlambda.png)

2. Click **Create function**.

![Click Create Function](/images/5-Workshop/5.6-create-fetch-invoice-lambda/002-createfunction.png)
...
![Configure Function](/images/5-Workshop/5.6-create-fetch-invoice-lambda/003-configurefunction.png)

2. Click **Create function**.

![Finish Creating Function](/images/5-Workshop/5.6-create-fetch-invoice-lambda/004-finishcreate.png)
...
![Paste Source Code](/images/5-Workshop/5.6-create-fetch-invoice-lambda/005-code.png)

2.  Click **Deploy** to save and apply the source code.

![Deploy](/images/5-Workshop/5.6-create-fetch-invoice-lambda/006-deploy.png)
...
![Edit General Configuration](/images/5-Workshop/5.6-create-fetch-invoice-lambda/007-editconfig.png)
...
![Set Memory and Timeout](/images/5-Workshop/5.6-create-fetch-invoice-lambda/008-settimeout.png)

3. **Configuration -> Environment variables**, click **Edit**,

![Set Environment variables](/images/5-Workshop/5.6-create-fetch-invoice-lambda/010-more.png)

4.  Click **Save**.

![Click Save](/images/5-Workshop/5.6-create-fetch-invoice-lambda/009-clicksave%20%282%29.png)
