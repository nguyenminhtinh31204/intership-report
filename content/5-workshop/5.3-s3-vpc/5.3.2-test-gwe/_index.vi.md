...
- Trong Bucket console, chọn **Create bucket**
...
- Từ **Systems Manager** menu, tìm **Node Management** ở thanh bên trái và chọn **Session Manager**:

![system manager](/images/5-Workshop/5.3-S3-vpc/sm1.png)

- Click Start Session, và chọn EC2 instance tên **Test-Gateway-Endpoint**.
...
- Đổi về ssm-user’s thư mục bằng lệnh “cd ~”

![Change user’s dir](/images/5-Workshop/5.3-S3-vpc/cli1.png)

- Tạo 1 file để kiểm tra bằng lệnh “fallocate -l 1G testfile.xyz”, 1 file tên “testfile.xyz” có kích thước 1GB sẽ được tạo.

![Create file](/images/5-Workshop/5.3-S3-vpc/cli-file.png)

- Tải file mình vừa tạo lên S3 với lệnh “aws s3 cp testfile.xyz s3://your-bucket-name”. Thay your-bucket-name bằng tên S3 bạn đã tạo.
...
- Trong Bucket console, bạn sẽ thấy tệp bạn đã tải lên S3 bucket của mình
