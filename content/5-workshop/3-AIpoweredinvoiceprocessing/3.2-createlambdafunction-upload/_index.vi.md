...
{{% notice warning %}}
⚠️ **Lưu ý**: Hãy đảm bảo bạn đang ở đúng **Region: Singapore (ap-southeast)** trước khi tạo Lambda function. Đây là vùng bạn đã tạo S3 bucket, DynamoDB table. Nếu chọn sai vùng, Lambda sẽ không thể truy cập được các dịch vụ khác của hệ thống.
{{% /notice %}}
