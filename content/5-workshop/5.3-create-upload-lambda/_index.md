...
![Open Lambda](/images/5-Workshop/5.3-create-upload-lambda/001-openlambda.png)
...
![Create Function](/images/5-Workshop/5.3-create-upload-lambda/002-createfunction.png)
...
![Configure Function](/images/5-Workshop/5.3-create-upload-lambda/003-configurefunction.png)

2. Click **Create function** to proceed.

![Configure Function](/images/5-Workshop/5.3-create-upload-lambda/004-createfunction.png)
...
![Paste Code](/images/5-Workshop/5.3-create-upload-lambda/005-sourcecode.png)

3. Click **Deploy** to apply the changes.

![Deploy](/images/5-Workshop/5.3-create-upload-lambda/006-deploy.png)
...
![Deploy](/images/5-Workshop/5.3-create-upload-lambda/007-configuration.png)
...
![Edit Memory Timeout](/images/5-Workshop/5.3-create-upload-lambda/008-configtimeout.png)

4. **Configuration -> Environment variables**, click **Edit**,

![Set Environment variables](/images/5-Workshop/3.4-fetchinvoicelambda/010-more.png)

5. Click **Save**.

![Click Save](/images/5-Workshop/5.3-create-upload-lambda/009-clicksave.png)
